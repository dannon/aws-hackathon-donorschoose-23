"""
Django settings for donorsdata project.
...
SECRET_KEY = 'a#j*_mwcjt**&a$fi32pza()dmi8&s8mp9$k=-kr4a3v6k=(cg'
...
ROOT_URLCONF = 'donorsdata.urls'

WSGI_APPLICATION = 'donorsdata.wsgi.application'
